from src.dataset import simple_dataset,word_context_dataset,word_context_entailment_dataset,word_entailment_dataset, combine_train_test
...
if __name__ == '__main__':
    ...
    def preprocess_function(examples):
        ...
        """
        result = tokenizer(
            examples["entailment"], truncation=True, max_length=max_length, padding=False)
